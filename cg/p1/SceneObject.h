...
public:
    ...
    void setParent(SceneObject* new_parent);
    ...
    const auto add_object(SceneObject* obj)
    {
        return _objects.emplace_back(obj);
    }

    auto remove_object(SceneObject* obj)
    {
    ...
    const auto add_component(Component* component)
    {
...
private:
    ...
    std::list<Component*> _components { &_transform };
